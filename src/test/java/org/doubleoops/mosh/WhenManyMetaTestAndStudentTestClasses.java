...
class WhenManyMetaTestAndStudentTestClasses {
	...
	void whenManyMetaTestAndStudentTestClasses() throws Exception {
		...
		STNode stNode = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsOneMethod", "test1");
		...
		stNode = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsSeveralMethods", "test1");
		assertNotNull(stNode);
		assertEquals(2, stNode.passCount());
		assertEquals(3, stNode.failCount());
		assertEquals(40.0, stNode.percentagePasses(), 0.0001);
		...
		stNode = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsSeveralMethods", "test2");
		assertNotNull(stNode);
		assertEquals(2, stNode.passCount());
		assertEquals(3, stNode.failCount());
		assertEquals(40.0, stNode.percentagePasses(), 0.0001);
		...
		stNode = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsSeveralMethods", "test3");
		assertNotNull(stNode);
		assertEquals(2, stNode.passCount());
		assertEquals(3, stNode.failCount());
		assertEquals(40.0, stNode.percentagePasses(), 0.0001);
		...
		stNode = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsOneMethod", "test1");
		assertNotNull(stNode);
		assertEquals(2, stNode.passCount());
		assertEquals(3, stNode.failCount());
		assertEquals(40.0, stNode.percentagePasses(), 0.0001);
		...
		STNode stNode1 = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsSeveralMethods", "test1");
		...
		STNode stNode2 = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsSeveralMethods", "test2");
		...
		STNode stNode3 = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsSeveralMethods", "test3");
		...
		STNode stNode4 = mtNode.getSTNode("org.doubleoops.mosh.testdata.StudentTestsOneMethod", "test1");
